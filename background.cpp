...
void Background::resetBackground(){
    main_coordinate.setXCoordinateToZero(0);
    first_coordinate = main_coordinate;
    second_coordinate = main_coordinate;
    third_coordinate = main_coordinate;
}

double Background::getFinishpoint(){
    return finish_point;
}
void Background::setFinishpoint(double change){
    finish_point = change;
}
...
*/
void Background::render(QPainter &painter, bool paused, int direction) {
    //printf("%d\n",paused);
    /*
    ...
    */
    ...
    //allow backward rendering
    Coordinate first_coordinate_wrap_bw(first_coordinate.getXCoordinate() - (100 + Config::config()->getWorldWidth()),
                                 first_coordinate.getYCoordinate(),
                                 first_coordinate.getFrameHeight(),
                                 first_coordinate.getFrameWidth());
    ...
    //allow backward rendering
    Coordinate second_coordinate_wrap_bw(second_coordinate.getXCoordinate() - (loading_gap + Config::config()->getWorldWidth()),
                                 second_coordinate.getYCoordinate(),
                                 second_coordinate.getFrameHeight(),
                                 second_coordinate.getFrameWidth());
    ...
    //allow backward rendering
    Coordinate third_coordinate_wrap_bw(third_coordinate.getXCoordinate() - Config::config()->getWorldWidth(),
                                 third_coordinate.getYCoordinate(),
                                 third_coordinate.getFrameHeight(),
                                 third_coordinate.getFrameWidth());
    ...
    */
    ...
    if (Config::config()->getBackgroundNumber() == 2) {
        if ((second_coordinate.getQtRenderingXCoordinate() < 0 - getSecond().width()) || ((second_coordinate.getQtRenderingXCoordinate() > 0) && (static_cast<unsigned int>(second_coordinate.getQtRenderingXCoordinate()) > Config::config()->getWorldWidth()))) {
    ...
    if ((third_coordinate.getQtRenderingXCoordinate() < 0 - getThird().width()) || ((third_coordinate.getQtRenderingXCoordinate() > 0) && (static_cast<unsigned int>(third_coordinate.getQtRenderingXCoordinate()) > Config::config()->getWorldWidth()))) {
    ...
    painter.drawPixmap(first_coordinate_wrap_bw.getQtRenderingXCoordinate(),
        first_coordinate_wrap.getQtRenderingYCoordinate(),
        getFirst());
    ...
    painter.drawPixmap(second_coordinate_wrap_bw.getQtRenderingXCoordinate(),
        second_coordinate_wrap.getQtRenderingYCoordinate(),
        getSecond());
    ...
    painter.drawPixmap(third_coordinate_wrap_bw.getQtRenderingXCoordinate(),
        third_coordinate_wrap.getQtRenderingYCoordinate(),
        getThird());
...
//        third_coordinate.changeInXCoordinate(-Config::config()->getStickman()->getVelocity());
        ...
        //std::fflush(stdout);
        //update main coordinate
        main_coordinate.changeInXCoordinate(direction * Config::config()->getStickman()->getVelocity());
        //update actual coordinates
        first_coordinate.changeInXCoordinate(direction * 0.2);
        if (Config::config()->getBackgroundNumber() == 2) {
            second_coordinate.changeInXCoordinate(-direction * 0.5);
        } else {
            second_coordinate.changeInXCoordinate(direction * 0.3);
        }
        third_coordinate.changeInXCoordinate(direction * Config::config()->getStickman()->getVelocity());
    }
