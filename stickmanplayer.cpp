...
double StickmanPlayer::getYvelocity(){
    return physics_body.getYVelocity();
}

void StickmanPlayer::setOffsetYCoordinate(int change){
    offset_position->setYCoordinateToZero(change);
}

void StickmanPlayer::setYvelocity(double change){
...
void StickmanPlayer::update(bool paused, double time_since_last_frame, int direction) {
    // Physics updates
